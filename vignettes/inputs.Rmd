...
dat <- dat[, c('region', 'country', 'year', 'zone', 'estimate', 'survey_area', 'modal_survey_area', 'density', 'n_surveys')]
```
...
reg_dat <- list(N = N, Y = Y, S = S, C = C, XY = X$Y, XC = X$C, XS = X$S,
                y = dat$density, 
                start = start,
                survey_area = t(areas), 
...
save(reg_dat, file = "../data/forest.rda")
```
...
save(reg_dat, file = "../data/savannah.rda")
```
