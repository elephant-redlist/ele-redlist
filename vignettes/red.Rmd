...
```{r, echo = FALSE}
inputs_forest$density_sim <- posterior(reg_ll_out, "y_sim", fun = "median")[[1]]

gg <- ggplot(inputs_forest) + 
...
```{r, echo = FALSE}
inputs_forest$density_sim <- posterior(reg_lp_out, "y_sim", fun = "median")[[1]]
